...
```bash
nahid@cseru:/media/nahid/data-center/workspace/cseru-labs/parallel-processing$ mpicc 4-sum.c 
nahid@cseru:/media/nahid/data-center/workspace/cseru-labs/parallel-processing$ mpirun -np 4 a.out --use-hwthread-cpus
From 3 rank: 42 is the sum value.
From 1 rank: 10 is the sum value.
From 2 rank: 26 is the sum value.
Total sum: 78
--------------------------------------------------------------------------
ERROR Message shows on my system....! I don't know what happened on other systems.
```
